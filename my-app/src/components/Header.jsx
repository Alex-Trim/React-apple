                      ...
                      <ul className="list--reset nav__list">
                          <li className="nav__item">
                              <Link className="link link--btn link--btn-basket" to='/basket'>
                                  ...
                                  <div className="link-btn--basket__delimiter"></div>
                                  <div className="link-btn--basket__product">
                                      <svg className="basket-icon" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
